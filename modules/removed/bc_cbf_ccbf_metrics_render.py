...
def main():
    ...
    print("="*50)
    cbf_qp_metrics_goal_reaching = evaluate_cbf_qp_controller(cbf_qp_controller_goal_reaching, env, num_episodes=10, render=False, render_delay=0.00001)
    ...
    print("="*50)
    cbf_qp_metrics_bc = evaluate_cbf_qp_controller(cbf_qp_controller_bc, env, num_episodes=10, render=False, render_delay=0.00001)
    ...
    print("="*50)
    cbf_qp_metrics_bc_safe = evaluate_cbf_qp_controller(cbf_qp_controller_bc_safe, env, num_episodes=10, render=False, render_delay=0.00001)


    ccbf_model = CBF(state_car_dim=2, state_obstacles_dim=2, dt=0.1, num_hidden_dim=3, dim_hidden=32).to(DEVICE)
    
    # Load checkpoint
    checkpoint = torch.load(CCBF_CHECKPOINT, map_location=DEVICE,weights_only=False)
    ...
    print("="*50)
    ccbf_qp_metrics_goal_reaching = evaluate_cbf_qp_controller(ccbf_qp_controller_goal_reaching, env, num_episodes=10, render=False, render_delay=0.00001)
    ...
    print("="*50)
    ccbf_qp_metrics_bc = evaluate_cbf_qp_controller(ccbf_qp_controller_bc, env, num_episodes=10, render=False, render_delay=0.00001)
    ...
    print("="*50)
    ccbf_qp_metrics_bc_safe = evaluate_cbf_qp_controller(ccbf_qp_controller_bc_safe, env, num_episodes=10, render=False, render_delay=0.00001)
