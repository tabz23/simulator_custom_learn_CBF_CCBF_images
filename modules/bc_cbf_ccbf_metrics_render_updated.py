...
CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/best_cbf_VAE_Deterministic_4_cql_478.pth"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/best_cbf_VAE_Deterministic_4_cql_915.pth"#idbf
...
# Prepare the methods and metrics for comparison
    ...
    with open("render.txt", "a") as f:
        ...
        f.write(f"CBF_CHECKPOINT alpha_{alpha}: {CCBF_CHECKPOINT}\n")
