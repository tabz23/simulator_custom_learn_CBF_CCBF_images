...
#https://www.perplexity.ai/search/import-torch-import-numpy-as-n-89sHj8TARvWARCkSHRLhoQ
...
def compute_multiple_shooting_loss(model, batch, device,
    ...
    for t in range(1, seq_length):
        ...
        z_prev = z_current.detach()  # Detach to prevent gradient accumulation
    ...
    for epoch in trange(epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):  # Keep track of batch index
            ...
            wandb.log({
                ...
                'epoch': epoch + (batch_idx / len(train_loader)) # for x axis
            })
        ...
        wandb.log({
            ...
            'epoch': epoch # for x axis
        })
        
        # Model checkpoint
        if avg_val_loss < best_val_loss:
            best_val_loss = avg_val_loss
            torch.save(model.state_dict(), 'CCBF_images_model.pth')
