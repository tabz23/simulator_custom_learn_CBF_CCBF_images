...
class VAE(torch.nn.Module):
    def __init__(self, input_channels, latent_dim, hidden_dim=64):
        ...
        self.encoder = torch.nn.Sequential(
            torch.nn.Conv2d(input_channels, 32, kernel_size=4, stride=2, padding=1),  # Output: 32x32
            torch.nn.ReLU(),
            torch.nn.Conv2d(32, 64, kernel_size=4, stride=2, padding=1),  # Output: 16x16
            torch.nn.ReLU(),
            torch.nn.Conv2d(64, 128, kernel_size=4, stride=2, padding=1),  # Output: 8x8
            torch.nn.ReLU(),
            torch.nn.Flatten(),
            torch.nn.Linear(128 * 8 * 8, hidden_dim),
            torch.nn.ReLU()
        )
        ...
        self.decoder = torch.nn.Sequential(
            ...
            torch.nn.ReLU(),
            torch.nn.ConvTranspose2d(64, 32, kernel_size=4, stride=2, padding=1),  # Output: 32x32
            torch.nn.ReLU(),
            torch.nn.ConvTranspose2d(32, input_channels, kernel_size=4, stride=2, padding=1),  # Output: 64x64
...
def visualize_vae_and_dynamics():
    ...
    vae_checkpoint_files = ['vae_model_final_3.pth', 'final_vae_model_3.pth']
    dynamics_checkpoint_files = ['dynamics_model_final_3.pth', 'final_dynamics_model_3.pth']
